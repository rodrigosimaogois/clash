...
export class TranslationService {
  ...
  private translations: Record<Language, Record<string, string>> = {
    pt: {
      ...
      ERR_OFFLINE: "Não foi possível conectar ao servidor. Verifique se a API está online.",
      ERR_SEARCH: "Erro ao buscar dados do clã.",
      TH_NAME: 'NOME',
      TH_CURRENT: 'ATUAL',
      TH_DECKS: 'DECKS',
      TH_PERSP: 'PERSP',
    ...
    en: {
      ...
      ERR_OFFLINE: "Unable to connect to the server. Please check if the API is running.",
      ERR_SEARCH: "Error fetching clan data.",
      TH_NAME: 'NAME',
      TH_CURRENT: 'CURRENT',
      TH_DECKS: 'DECKS',
      TH_PERSP: 'PERSP',
